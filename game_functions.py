...
BULLET_FIRE_SOUND = pygame.mixer.Sound("Gun+Silencer.wav")
...
def check_play_button(setting, screen, stats, sb, play_button, ship,  aliens,
...
def update_bullets(setting, screen, stats, sb, ship, aliens, bullets):
    ...
    check_bullet_alien_collisions(setting, screen, stats, sb,
                                  ship, aliens, bullets)
    
    
def check_bullet_alien_collisions(setting, screen, stats, sb, ship,
                                  aliens, bullets):
...
def update_screen(setting, screen, stats, sb, ship, aliens, bullets, play_button):
